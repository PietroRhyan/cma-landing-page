...
export default function Home() {
  return (
    <div>
        ...
        <main className="w-full pt-12 flex flex-col slg:flex-row items-start gap-10 slg:gap-0 slg:justify-between">
          <div className="space-y-6" >
            <h1 className="text-poppins text-3xl sm:text-5xl lgp:text-6xl font-bold max-w-[635px] lgp:max-w-[835px] text-pretty">
              Alavanque sua{' '}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow via-dark-yellow to-darkest-yellow">carreira</span>{' '}
              e transforme sua melodia em{' '}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow via-dark-yellow to-darkest-yellow">sucesso</span>
            </h1>

            <p className="max-w-[475px] lgp:max-w-[650px] text-sm lgp:text-base font-medium">
              A CMA Digital Music irá lidar com toda a burocracia e oferecer suporte para divulgação e o gerenciamento da sua
              carreira em diversas plataformas digitais e tradicionais, como emissoras de rádio. Siga conosco e conheça nossos projetos.
            </p>
            ...
            <div className="relative w-[268px] h-[300px] sm:w-[300px] sm:h-[350px]" >
              ...
              <div className="w-[115px] absolute -top-[18px] -right-[4px] sm:-right-[50px] bg-white border border-light-gray rounded-[4px] p-[4px] space-y-[10px] shadow-float-thin" >
                <div className="flex items-center justify-between text-gray" >
                  <span className="text-poppins text-[10px] font-semibold">Visualizações</span>
                  <IoEyeOutline size={12} />
                </div>

                <span className="block text-poppins font-semibold text-sm text-end">3.372.020</span>
              </div>
              <div className="w-[165px] absolute -bottom-[18px] -left-[4px] sm:-left-12 bg-white border border-light-gray rounded-[4px] p-[4px] space-y-[10px] shadow-float-thin" >
                <div className="flex items-center justify-between text-gray" >
                  <span className="text-poppins text-[10px] font-semibold">Valores a receber</span>
                ...
                <div className="flex items-center justify-end gap-1 text-green" >
                  <div className="flex items-center gap-[2px]" >
                    ...
                    <span className="block text-poppins font-normal text-[10px]">19%</span>
                  </div>

                  <span className="block text-poppins font-semibold text-sm">U$ 4.278,28</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="sobre" className="max-w-7xl w-full px-4 sm:px-8 md:px-12 mx-auto relative pb-16 border-t border-light-gray" >
        <div className="w-fit md:max-w-[515px] lg:max-w-[860px] md:w-full absolute -top-6 left-1/2 -translate-x-1/2 rounded-xl bg-white border border-light-gray p-6 lg:p-8 flex item-center gap-8" >
          <h3 className="hidden lg:block text-poppins font-medium text-2xl max-w-[250px]">Nós ajudamos os artistas a atingerem seu potencial</h3>
